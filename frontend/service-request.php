                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="filter">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                ...
                                <li><a class="dropdown-item" href="btn_reschedule">Add</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title">Schedules</h5>

                            <button id="add_schoalarships_modal" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_schoalarships_modal">
                                Request Schedule
                            </button>
