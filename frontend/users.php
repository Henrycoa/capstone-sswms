              ...
              <div class="card recent-sales overflow-auto custom-border">
                ...
                <div class="card-body">
                  ...
                  <table class="table table-bordered datatable" id="tbl_users">
                    <thead>
                      <tr>
                        <th id="users_application_name" scope="col">Name</th>
                        <th id="users_application_type" scope="col">Email</th>
                        <th id="users_application_action" scope="col">User Role</th> <!-- Add Action column -->
            ...
            data.forEach(item => {
              rows += `
                        <tr id="row_${item.user_id}">
                            ...
                            <td>  
                            <button type="button" class="btn btn-primary btn-sm me-1" onclick="FuncEditUser('${JSON.stringify(item).replace(/"/g, '&quot;')}');">Update</button></td>
                        </tr>
                    `;
            });
